...
public class PicklockDoor : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        PicklockObject.GetComponent<Picklock>().isCorrect = false;
    ...
    void Update()
    {
        ...
        {
            if (!isOpen && PicklockObject.GetComponent<Picklock>().isCorrect)
            {
                StartCoroutine(OpenDoor());
            }
            else if (!isOpen && !PicklockObject.GetComponent<Picklock>().isCorrect)
            {
