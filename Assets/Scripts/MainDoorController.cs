...
namespace KeySystem
{
    public class MainDoorController : MonoBehaviour
    {
        ...
        [SerializeField] private string Open = "OpenDoor";
        [SerializeField] private string Close = "CloseDoor";
        ...
        [SerializeField] private CodeLock _code = null;
        [SerializeField] private ColorCode _colorCode = null;
        ...
        {
            if (_keyInventory.hasMainKey && _itemController.MainDoor && _code.isCorrect && _colorCode.isCorrect)
            {
